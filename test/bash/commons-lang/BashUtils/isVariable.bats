...
@test "BashUtils.isVariable fails when the input name is not a valid variable name" {
...
@test "BashUtils.isVariable succeed when the variable has been declared" {
  local myVar="myValue"
  BashUtils.isVariable "myVar"
}

@test "BashUtils.isVariable fails when the variable is an array or a map" {
  declare -a myArray=()
