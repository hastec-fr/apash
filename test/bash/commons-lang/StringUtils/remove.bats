...
@test "StringUtils.remove returns an empty string when the input string is empty " {
...
@test "StringUtils.remove returns the full string if the substring to remove is empty " {
...
@test "StringUtils.remove returns the string without occurence of the substring to remove " {
...
@test "StringUtils.remove returns the orginal string if no occurence of the substring occurs" {
